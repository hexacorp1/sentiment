...
-----===============================================================================================
LOCATION '/tmp/flume/twitter/%Y/%m/%d'-- this will change
;

-- We have included the year, month and date partition in the above location since we are giving the above parameters during the Oozie workflow and the data gets partitioned according to the year,date and time.
